...
public class AxisOrientedBoundingBox {
  ...
  public AxisOrientedBoundingBox(Vector3 position, Dimensions3 dimensions, EulerAngles angles) {
  ...
  public boolean isColliding(AxisOrientedBoundingBox other) {
  ...
  private Vector3[] getSeparatingAxes(AxisOrientedBoundingBox other) {
  ...
  private boolean overlapsOnAxis(Vector3 axis, AxisOrientedBoundingBox other) {
